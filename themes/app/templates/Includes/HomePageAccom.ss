    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-4 col-12" align="center">
            <picture class="accom__images">
                <source srcset="$Accom1.Fill(202,202).URL()" media="(min-width: 992px)" />
        ...
        <div class="col-lg-4 col-md-4 col-12" align="center">
            <picture class="accom__images">
                <source srcset="$Accom2.Fill(202,202).URL()" media="(min-width: 992px)" />
        ...
        <div class="col-lg-4 col-md-4 col-12" align="center">
            <picture class="accom__images">
                <source srcset="$Accom3.Fill(202,202).URL()" media="(min-width: 992px)" />
